...
const mockPendingReports = [
  ...
  { id: '3', type: 'SMS', content: 'URGENT: Your package is being held...', reporter: 'anonymous', date: '1 hour ago' },
];
...
export default function AdminPage() {
  const [activeTab, setActiveTab] = useState<'reports' | 'users' | 'rules'>('reports');

  const tabs = [
    { key: 'reports' as const, label: 'Pending Reports', icon: FileText },
    { key: 'users' as const, label: 'Users', icon: Users },
    { key: 'rules' as const, label: 'Rules', icon: Globe },
  ];
